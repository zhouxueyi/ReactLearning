...
//
// function reloadVer () {
//     var ver_link = $(".my-input .ver-container img");
//
//     ver_link.setAttribute('src','http://10.106.165.129:9000/capcha?width=100&height=50');
// };
...
input.blur(function (event) {
    ...
    // debugger;
    var target = $(event.target);
    var regist_btn = $("#register_button");
    if (target.val() == "") {
...
var _MyInput = __webpack_require__(89);
    ...
    _createClass(MyComponent, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('img', { className: 'bg-img', src: 'http://microloan-fe-test.yxapp.xyz/img/banner1.png' }),
                _react2.default.createElement(
                    'form',
                    { className: 'resgist-form', onChange: this.aaa },
                    _react2.default.createElement(_MyInput2.default, { type: 'text', className: 'tel', placeholder: '\u8BF7\u8F93\u5165\u624B\u673A\u53F7', text: this.state.num, onFocus: this.bbb }),
                    _react2.default.createElement(_MyInput2.default, { type: 'password', className: 'pas', placeholder: '\u8BF7\u8F93\u5165\u5BC6\u7801' }),
                    _react2.default.createElement(_MyInput2.default, { type: 'text', className: 'ver', placeholder: '\u8BF7\u8F93\u5165\u53F3\u4FA7\u9A8C\u8BC1\u7801', src: 'http://10.106.165.129:9000/capcha?width=100&height=50' }),
                    _react2.default.createElement(_MyInput2.default, { type: 'text', className: 'telver', placeholder: '\u8BF7\u8F93\u5165\u624B\u673A\u9A8C\u8BC1\u7801' }),
                    _react2.default.createElement(
                        'a',
                        { href: '#', id: 'register_button', className: 'button', disabled: true },
                        '\u7ACB\u5373\u7533\u8BF7'
                    )
                )
            );
...
var _MyComponent = __webpack_require__(86);
...
_reactDom2.default.render(_react2.default.createElement(_MyComponent2.default, null), document.getElementById('container'));
...
var MyInput = function (_React$Component) {
    ...
    function MyInput(props) {
        ...
        _this.reloadVer = function () {
            console.log("reload");
            var ver_link = document.getElementById("ver-text");
    ...
    _createClass(MyInput, [{
        ...
        key: "render",
        value: function render() {
            if (this.props.className == "tel" || this.props.className == "pas") {
                return _react2.default.createElement(
                    "div",
                    { className: "my-input" },
                    _react2.default.createElement("input", { type: this.state.type, className: this.props.className, placeholder: this.props.placeholder }),
                    _react2.default.createElement(
                        "i",
                        { className: "warn-icon" },
                        "!"
            ...
            } else if (this.props.className == "ver") {
                return _react2.default.createElement(
                    "div",
                    { className: "my-input" },
                    _react2.default.createElement("input", { type: this.state.type, className: this.props.className, placeholder: this.props.placeholder }),
                    _react2.default.createElement(
                        "div",
                        { className: "ver-container" },
                        _react2.default.createElement("img", { id: "ver-text", src: this.state.verSrc })
                    )
                );
            } else {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "ver-container", onClick: this.sendMess() },
                        _react2.default.createElement(
                            "i",
                            { className: "tel-ver-text" },
                            "\u83B7\u53D6\u9A8C\u8BC1\u7801"
                        )
                    )
                );
